                ...
                <div class="col-lg-3 col-md-3 d-flex justify-content-center align-items-center">
                    ...
                    @else
                        ...
                        <div class="box_login_success" style="margin-left: 5px">
                            <a href="javascript:void(0);" style="color: black;" id="view_notification" class="dropdown-login-sucess" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="avatar" style="text-align: center; padding-top:6px;">
                                    ...
                                    <span style="position: absolute;
                                        ...
                                        background: red;
                                        color: white;
                                        font-size: 10px;" id="count_notificaiton">{{ countNotification() }}</span>
                                    @endif
                                </div>
                            </a>
                            <div class="dropdown-menu" id="notification_detail">
